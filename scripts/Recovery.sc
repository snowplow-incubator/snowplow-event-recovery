...
import $ivy.`org.typelevel::cats-core:2.7.0`, cats.Id, cats.instances.list._, cats.syntax.traverse._, cats.syntax.either._
import $ivy.`io.circe::circe-parser:0.14.1`, io.circe._, io.circe.syntax._, io.circe.parser._
import $ivy.`com.snowplowanalytics::snowplow-event-recovery-core:0.5.0`, com.snowplowanalytics.snowplow.event.recovery._, config._, json._
