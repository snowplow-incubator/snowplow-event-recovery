// local.sc
// This file contains a set of helper tools for working with recovery
...
import $ivy.`com.snowplowanalytics::snowplow-event-recovery-core:0.2.0-rc5`, com.snowplowanalytics.snowplow.event.recovery._, config._, json._
