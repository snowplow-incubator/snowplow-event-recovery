...
object gens {
  ...
  // implicit val fieldDoesNotExistA = implicitly[Arbitrary[FieldDoesNotExist]]
  // implicit val unrecoverableBadRowTypeA = implicitly[Arbitrary[UnrecoverableBadRowType]]
